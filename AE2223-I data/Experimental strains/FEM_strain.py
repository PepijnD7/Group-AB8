...
def FEM_DATA_PLOT():#list of lists witf fem[i][j] i being the loadstep with (xcord,axial,bending)
    ...
    for i in range(0,len(x)-1):
        length = length + sqrt((abs(x[i]-x[i+1]))**2 + (abs(y[i]-y[i+1]))**2 )/1000
        arc.append(length)
        i = i+1
    ########################################################################################################
    ...
    return [(arc,AxialStrain1,bendingstrain1),(arc,AxialStrain2,bendingstrain2),(arc,AxialStrain3,bendingstrain3),(arc,AxialStrain4,bendingstrain4),(arc,AxialStrain5,bendingstrain5)]########################################################################################################
